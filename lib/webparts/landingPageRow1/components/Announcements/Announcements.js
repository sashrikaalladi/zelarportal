...
var Announcements = function (props) {
    var _a = React.useState([]), announcementData = _a[0], setAnnouncementData = _a[1];
    var getData = function () { return __awaiter(void 0, void 0, void 0, function () {
        var d;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getAnnouncementsData(props.context)];
                case 1:
                    d = _a.sent();
    ...
    return (React.createElement("div", { className: 'rowMain' },
        ...
        React.createElement(Marquee, { speed: 10, direction: 'up', className: 'marqueetag' },
            React.createElement("div", { className: 'row1' }, announcementData === null || announcementData === void 0 ? void 0 : announcementData.map(function (x) {
