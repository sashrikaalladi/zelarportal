...
var News = function (props) {
    ...
    var getDataNews = function () { return __awaiter(void 0, void 0, void 0, function () {
        var b;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getNewsData(props.context)];
                case 1:
                    b = _a.sent();
                    setNewsData(b);
                    return [2 /*return*/];
    ...
    return (React.createElement("div", { className: 'rowMain' },
        ...
        React.createElement(Marquee, { speed: 10, direction: 'up', className: 'marqueetag' },
            React.createElement("div", { className: 'row1' }, newsdata === null || newsdata === void 0 ? void 0 : newsdata.map(function (x) {
