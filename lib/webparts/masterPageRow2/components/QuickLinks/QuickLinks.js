...
var QuickLinks = function (props) {
    var _a = React.useState(), quicklinkdata = _a[0], SetQuickLinkData = _a[1];
    var getQuick = function () { return __awaiter(void 0, void 0, void 0, function () {
        var arr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getQuickLinkData(props.data)];
                case 1:
                    arr = _a.sent();
    ...
    return (React.createElement(React.Fragment, null, quicklinkdata === null || quicklinkdata === void 0 ? void 0 : quicklinkdata.map(function (x) {
