...
var ImageSliders = function (props) {
    ...
    var _b = React.useState(), imagedata = _b[0], setImageData = _b[1];
    var getImage = function () { return __awaiter(void 0, void 0, void 0, function () {
        var arr;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getImageData(props.data)];
                case 1:
                    arr = _a.sent();
                    setImageData(arr);
    ...
    if (loading) {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Slide, null, imagedata && (imagedata === null || imagedata === void 0 ? void 0 : imagedata.map(function (x) {
